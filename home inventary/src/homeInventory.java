...
public class homeInventory extends JFrame{
        ...
        final String s1[] = { "Jalpaiguri", "Mumbai", "Noida", "Kolkata", "New Delhi" };
        ...
        JComboBox locationComboBox = new JComboBox(s1);
    ...
    homeInventory()
    {
        ...
        setResizable(false);
        add(mn);
        mn.setBounds(0,0,730,570);
        mn.setLayout(null);
        mn.setBackground(new Color(223,245,206));
        ...
        photoTextArea.setBackground(new Color(146, 119, 179));
       ...
       mn.add(photoButton);
       mn.add(photoLabel);
       mn.add(photoTextArea);
       mn.add(noteLabel);
       mn.add(noteTextField);
       mn.add(storeTextField);
       mn.add(storeLabel);
       mn.add(dateDateChooser);
       mn.add(dateLabel);
       mn.add(priceTextField);
       mn.add(priceLabel);
       mn.add(serialLabel);
       mn.add(serialTextField);
       mn.add(markedCheckBox);
       mn.add(locationComboBox);
       mn.add(locationLabel);
       mn.add(itemLabel);
       mn.add(itemTextField);
